...
export const settingsDict = {
  ...
  'settings.voice.page.tooltip.sttBrowser': 'Reconnaissance intégrée des navigateurs compatibles. Gratuit, sans configuration.',
  'settings.voice.page.browserTest.title': 'Tester le microphone',
  'settings.voice.page.browserTest.stop': 'Arrêter le test',
  'settings.voice.page.browserTest.transcript': 'Le texte reconnu apparaîtra ici.',
  'settings.voice.page.browserTest.description': 'Parlez pour vérifier la reconnaissance et le volume du microphone. Le texte reste dans cet aperçu et ne sera pas envoyé au chat. Votre navigateur peut envoyer le son à son service de reconnaissance vocale.',
  'settings.voice.page.browserTest.unavailable': 'La reconnaissance vocale du navigateur est indisponible ici. Ouvrez ce site via HTTPS dans un navigateur compatible ou choisissez Local ou Serveur. Les applications de bureau et mobiles natives ne sont pas prises en charge.',
  'settings.voice.page.browserFallback': 'La reconnaissance du navigateur a été choisie sur un autre appareil. Cet appareil ne la prend pas en charge, Local est donc utilisé ici.',
  'settings.voice.page.browserTest.error': 'Reconnaissance vocale arrêtée ({code}). Vérifiez les autorisations du microphone et votre connexion, puis réessayez. Le texte reconnu est conservé.',
  'settings.voice.page.browserTest.error.busy': 'Une autre dictée est déjà en cours sur cette page. Arrêtez-la d’abord, puis réessayez.',
  'settings.voice.page.browserTest.error.network': 'Le service de reconnaissance est injoignable. Vérifiez votre connexion puis réessayez. Le texte reconnu est conservé.',
  'settings.voice.page.browserTest.error.noSpeech': 'Aucune parole détectée. Rapprochez-vous du microphone et réessayez.',
  'settings.voice.page.browserTest.error.audioCapture': 'Le niveau du microphone est indisponible. L’enregistrement continue sans lui.',
  'settings.voice.page.browserTest.error.timeout': 'Le service de reconnaissance n’a pas répondu à temps. Le texte reconnu est conservé.',
  'settings.voice.page.browserTest.error.startFailed': 'La reconnaissance n’a pas pu démarrer. Rechargez la page puis réessayez.',
  'settings.voice.page.browserTest.error.permission': 'L’accès au microphone a été refusé. Autorisez le microphone dans les réglages du site près de la barre d’adresse, rechargez la page puis réessayez.',
  'settings.voice.page.field.browserMicrophonePermission': 'Quand vous appuyez sur le microphone dans le chat ou lancez le test ci-dessous, autorisez l’accès au microphone si le navigateur le demande. Si aucune demande ne semble apparaître ou si cet accès est bloqué, ouvrez les réglages du site près de la barre d’adresse, autorisez le microphone, puis rechargez la page et réessayez.',
