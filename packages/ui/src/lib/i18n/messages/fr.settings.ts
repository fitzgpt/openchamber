...
export const settingsDict = {
  ...
  'settings.voice.page.field.browserMicrophonePermission': 'Lorsque vous appuyez sur le microphone dans le chat, autorisez son accès si le navigateur le demande. Si aucune demande ne semble apparaître ou si cet accès est bloqué, ouvrez les paramètres du site à côté de la barre d’adresse, autorisez le microphone, puis rechargez la page et réessayez.',
