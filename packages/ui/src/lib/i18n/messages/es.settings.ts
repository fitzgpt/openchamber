...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.voice.page.tooltip.sttBrowser": "Reconocimiento integrado en navegadores compatibles. Gratis, sin configuración.",
  "settings.voice.page.browserTest.title": "Probar micrófono",
  "settings.voice.page.browserTest.stop": "Detener prueba",
  "settings.voice.page.browserTest.transcript": "El texto reconocido aparecerá aquí.",
  "settings.voice.page.browserTest.description": "Habla para comprobar el reconocimiento y el volumen del micrófono. El texto permanece en esta vista previa y no se envía al chat. El navegador puede enviar audio a su servicio de reconocimiento de voz.",
  "settings.voice.page.browserTest.unavailable": "El reconocimiento de voz del navegador no está disponible aquí. Abre este sitio por HTTPS en un navegador compatible o elige Local o Servidor. Las aplicaciones de escritorio y móviles nativas no son compatibles.",
  "settings.voice.page.browserFallback": "El reconocimiento del navegador se eligió en otro dispositivo. Este dispositivo no lo admite, así que aquí se usa Local.",
  "settings.voice.page.browserTest.error": "El reconocimiento de voz se detuvo ({code}). Revisa los permisos del micrófono y la conexión e inténtalo de nuevo. Se conserva el texto reconocido.",
  "settings.voice.page.browserTest.error.busy": "Ya hay un dictado grabando en esta página. Deténgalo primero e inténtelo de nuevo.",
  "settings.voice.page.browserTest.error.network": "No se pudo contactar el servicio de reconocimiento. Compruebe su conexión e inténtelo de nuevo. El texto reconocido se conserva.",
  "settings.voice.page.browserTest.error.noSpeech": "No se escuchó ninguna voz. Acérquese al micrófono e inténtelo de nuevo.",
  "settings.voice.page.browserTest.error.audioCapture": "El medidor de volumen del micrófono no está disponible. La grabación continúa sin él.",
  "settings.voice.page.browserTest.error.timeout": "El servicio de reconocimiento no terminó a tiempo. El texto reconocido se conserva.",
  "settings.voice.page.browserTest.error.startFailed": "No se pudo iniciar el reconocimiento. Recargue la página e inténtelo de nuevo.",
  "settings.voice.page.browserTest.error.permission": "Se denegó el acceso al micrófono. Permita el micrófono en los controles del sitio junto a la barra de direcciones, recargue la página e inténtelo de nuevo.",
  "settings.voice.page.field.browserMicrophonePermission": "Al pulsar el micrófono en el chat o iniciar la prueba siguiente, permite el acceso si el navegador lo solicita. Si no aparece la solicitud o el acceso está bloqueado, abre la configuración del sitio junto a la barra de direcciones, permite el micrófono, recarga la página y vuelve a intentarlo.",
