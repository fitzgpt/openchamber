...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.voice.page.tooltip.sttBrowser': '受支持浏览器内置识别。免费，无需配置。',
  'settings.voice.page.browserTest.title': '测试麦克风',
  'settings.voice.page.browserTest.stop': '停止测试',
  'settings.voice.page.browserTest.transcript': '识别的文本将显示在这里。',
  'settings.voice.page.browserTest.description': '说话以检查语音识别和麦克风音量。文本仅保留在此预览中，不会发送到聊天。浏览器可能会将音频发送到其语音识别服务。',
  'settings.voice.page.browserTest.unavailable': '此处无法使用浏览器语音识别。请使用受支持的浏览器通过 HTTPS 打开此网站，或选择本地或服务器。桌面应用和原生移动应用不受支持。',
  'settings.voice.page.browserFallback': '浏览器识别是在另一台设备上选择的。此设备不支持该功能，因此这里改用本地识别。',
  'settings.voice.page.browserTest.error': '语音识别已停止（{code}）。请检查麦克风权限和网络连接，然后重试。已识别的文本会保留。',
  'settings.voice.page.browserTest.error.busy': '此页面上已有另一段听写正在录音。请先停止它，然后重试。',
  'settings.voice.page.browserTest.error.network': '无法连接到语音识别服务。请检查连接后重试。已识别的文本会保留。',
  'settings.voice.page.browserTest.error.noSpeech': '未听到语音。请靠近麦克风后重试。',
  'settings.voice.page.browserTest.error.audioCapture': '麦克风音量表不可用。录音将在没有音量表的情况下继续。',
  'settings.voice.page.browserTest.error.timeout': '语音识别服务未能及时完成。已识别的文本会保留。',
  'settings.voice.page.browserTest.error.startFailed': '无法启动识别。请重新加载页面后重试。',
  'settings.voice.page.browserTest.error.permission': '麦克风访问被拒绝。请在地址栏旁的网站设置中允许麦克风，重新加载页面后重试。',
  'settings.voice.page.field.browserMicrophonePermission': '当您按下聊天中的麦克风或启动下面的测试时，如果浏览器请求，请允许麦克风访问。如果没有出现提示或访问被阻止，请打开地址栏旁的网站设置，在网站设置中允许麦克风，然后重新加载并重试。',
