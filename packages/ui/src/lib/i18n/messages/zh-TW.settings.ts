...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.voice.page.tooltip.sttBrowser': '支援的瀏覽器內建辨識。免費，無須設定。',
  'settings.voice.page.browserTest.title': '測試麥克風',
  'settings.voice.page.browserTest.stop': '停止測試',
  'settings.voice.page.browserTest.transcript': '辨識的文字將顯示在這裡。',
  'settings.voice.page.browserTest.description': '說話以檢查語音辨識和麥克風音量。文字僅保留在此預覽中，不會傳送到聊天。瀏覽器可能會將音訊傳送到其語音辨識服務。',
  'settings.voice.page.browserTest.unavailable': '此處無法使用瀏覽器語音辨識。請使用支援的瀏覽器透過 HTTPS 開啟此網站，或選擇本機或伺服器。不支援桌面應用程式和原生行動應用程式。',
  'settings.voice.page.browserFallback': '瀏覽器辨識是在另一部裝置上選擇的。此裝置不支援該功能，因此這裡改用本機辨識。',
  'settings.voice.page.browserTest.error': '語音辨識已停止（{code}）。請檢查麥克風權限和網路連線，然後重試。已辨識的文字會保留。',
  'settings.voice.page.browserTest.error.busy': '此頁面上已有另一段聽寫正在錄音。請先停止它，然後重試。',
  'settings.voice.page.browserTest.error.network': '無法連線到語音辨識服務。請檢查連線後重試。已辨識的文字會保留。',
  'settings.voice.page.browserTest.error.noSpeech': '未聽到語音。請靠近麥克風後重試。',
  'settings.voice.page.browserTest.error.audioCapture': '麥克風音量表無法使用。錄音將在沒有音量表的情況下繼續。',
  'settings.voice.page.browserTest.error.timeout': '語音辨識服務未能及時完成。已辨識的文字會保留。',
  'settings.voice.page.browserTest.error.startFailed': '無法啟動辨識。請重新載入頁面後重試。',
  'settings.voice.page.browserTest.error.permission': '麥克風存取被拒絕。請在網址列旁的網站設定中允許麥克風，重新載入頁面後重試。',
  'settings.voice.page.field.browserMicrophonePermission': '當您按下聊天中的麥克風或啟動下面的測試時，如果瀏覽器要求，請允許麥克風存取。如果沒有出現提示或存取被封鎖，請開啟網址列旁的網站設定，在網站設定中允許麥克風，然後重新載入並重試。',
