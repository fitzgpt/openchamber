...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.voice.page.tooltip.sttBrowser': 'Wbudowane rozpoznawanie w obsługiwanych przeglądarkach. Bezpłatne, bez konfiguracji.',
  'settings.voice.page.browserTest.title': 'Testuj mikrofon',
  'settings.voice.page.browserTest.stop': 'Zatrzymaj test',
  'settings.voice.page.browserTest.transcript': 'Rozpoznany tekst pojawi się tutaj.',
  'settings.voice.page.browserTest.description': 'Mów, aby sprawdzić rozpoznawanie i poziom mikrofonu. Tekst pozostaje w tym podglądzie i nie jest wysyłany na czat. Przeglądarka może przesyłać dźwięk do swojej usługi rozpoznawania mowy.',
  'settings.voice.page.browserTest.unavailable': 'Rozpoznawanie mowy w przeglądarce jest tutaj niedostępne. Otwórz stronę przez HTTPS w obsługiwanej przeglądarce albo wybierz Lokalnie lub Serwer. Aplikacje komputerowe i natywne aplikacje mobilne nie są obsługiwane.',
  'settings.voice.page.browserFallback': 'Rozpoznawanie przeglądarkowe wybrano na innym urządzeniu. To urządzenie go nie obsługuje, więc używane jest ustawienie lokalne.',
  'settings.voice.page.browserTest.error': 'Rozpoznawanie mowy zatrzymane ({code}). Sprawdź uprawnienia mikrofonu i połączenie, a następnie spróbuj ponownie. Rozpoznany tekst zostaje zachowany.',
  'settings.voice.page.browserTest.error.busy': 'Na tej stronie trwa już inne dyktowanie. Najpierw je zatrzymaj, a potem spróbuj ponownie.',
  'settings.voice.page.browserTest.error.network': 'Nie można połączyć się z usługą rozpoznawania. Sprawdź połączenie i spróbuj ponownie. Rozpoznany tekst zostaje zachowany.',
  'settings.voice.page.browserTest.error.noSpeech': 'Nie usłyszano mowy. Podejdź bliżej mikrofonu i spróbuj ponownie.',
  'settings.voice.page.browserTest.error.audioCapture': 'Miernik głośności mikrofonu jest niedostępny. Nagrywanie trwa bez niego.',
  'settings.voice.page.browserTest.error.timeout': 'Usługa rozpoznawania nie zdążyła odpowiedzieć. Rozpoznany tekst zostaje zachowany.',
  'settings.voice.page.browserTest.error.startFailed': 'Nie można uruchomić rozpoznawania. Odśwież stronę i spróbuj ponownie.',
  'settings.voice.page.browserTest.error.permission': 'Odmówiono dostępu do mikrofonu. Zezwól na mikrofon w ustawieniach witryny obok paska adresu, odśwież stronę i spróbuj ponownie.',
  'settings.voice.page.field.browserMicrophonePermission': 'Gdy naciśniesz mikrofon na czacie lub uruchomisz poniższy test, zezwól na dostęp do mikrofonu, jeśli przeglądarka o to poprosi. Jeśli pytanie się nie pojawia lub dostęp jest zablokowany, otwórz ustawienia witryny obok paska adresu, zezwól na mikrofon, odśwież stronę i spróbuj ponownie.',
