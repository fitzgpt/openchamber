...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.voice.page.field.browserMicrophonePermission': 'Po naciśnięciu mikrofonu na czacie zezwól na dostęp do niego, jeśli przeglądarka o to poprosi. Jeśli pytanie się nie pojawia lub dostęp jest zablokowany, otwórz ustawienia witryny obok paska adresu, zezwól na mikrofon, a następnie odśwież stronę i spróbuj ponownie.',
