...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.voice.page.tooltip.sttBrowser': '지원 브라우저 내장 인식. 무료, 설정 불필요.',
  'settings.voice.page.browserTest.title': '마이크 테스트',
  'settings.voice.page.browserTest.stop': '테스트 중지',
  'settings.voice.page.browserTest.transcript': '인식된 텍스트가 여기에 표시됩니다.',
  'settings.voice.page.browserTest.description': '말을 해서 음성 인식과 마이크 볼륨을 확인하세요. 텍스트는 이 미리보기에만 표시되며 채팅으로 전송되지 않습니다. 브라우저가 음성을 음성 인식 서비스로 전송할 수 있습니다.',
  'settings.voice.page.browserTest.unavailable': '여기서는 브라우저 음성 인식을 사용할 수 없습니다. 지원되는 브라우저에서 HTTPS로 열거나 로컬 또는 서버를 선택하세요. 데스크톱 및 네이티브 모바일 앱은 지원되지 않습니다.',
  'settings.voice.page.browserFallback': '브라우저 인식은 다른 기기에서 선택되었습니다. 이 기기에서는 지원되지 않으므로 여기서는 로컬을 사용합니다.',
  'settings.voice.page.browserTest.error': '음성 인식이 중지되었습니다({code}). 마이크 권한과 연결을 확인한 후 다시 시도하세요. 인식된 텍스트는 유지됩니다.',
  'settings.voice.page.browserTest.error.busy': '이 페이지에서 이미 다른 음성 입력이 녹음 중입니다. 먼저 중지한 뒤 다시 시도하세요.',
  'settings.voice.page.browserTest.error.network': '음성 인식 서비스에 연결할 수 없습니다. 연결을 확인한 뒤 다시 시도하세요. 인식된 텍스트는 유지됩니다.',
  'settings.voice.page.browserTest.error.noSpeech': '음성이 감지되지 않았습니다. 마이크에 가까이 대고 다시 시도하세요.',
  'settings.voice.page.browserTest.error.audioCapture': '마이크 볼륨 미터를 사용할 수 없습니다. 미터 없이 녹음을 계속합니다.',
  'settings.voice.page.browserTest.error.timeout': '음성 인식 서비스가 시간 안에 끝나지 않았습니다. 인식된 텍스트는 유지됩니다.',
  'settings.voice.page.browserTest.error.startFailed': '인식을 시작할 수 없습니다. 페이지를 새로고침한 뒤 다시 시도하세요.',
  'settings.voice.page.browserTest.error.permission': '마이크 접근이 거부되었습니다. 주소 표시줄 옆 사이트 설정에서 마이크를 허용하고 페이지를 새로고침한 뒤 다시 시도하세요.',
  'settings.voice.page.field.browserMicrophonePermission': '채팅에서 마이크를 누르거나 아래 테스트를 시작할 때 브라우저가 요청하면 마이크 접근을 허용하세요. 요청이 나타나지 않거나 접근이 차단된 경우 주소 표시줄 옆 사이트 설정에서 마이크를 허용하고 페이지를 새로고침한 뒤 다시 시도하세요.',
