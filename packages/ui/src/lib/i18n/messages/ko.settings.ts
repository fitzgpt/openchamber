...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.voice.page.field.browserMicrophonePermission': '채팅에서 마이크 버튼을 눌렀을 때 브라우저가 권한을 요청하면 마이크 접근을 허용하세요. 권한 요청이 나타나지 않거나 접근이 차단된 경우 주소 표시줄 옆에서 사이트 설정을 열어 마이크를 허용한 후 페이지를 새로고침하고 다시 시도하세요.',
